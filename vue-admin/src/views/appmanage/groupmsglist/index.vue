...
<div class="projects box-wrap">
    <el-form @submit.native.prevent>
        ...
        <el-form-item>
            <el-button v-hasPermission="'group:add'" type="primary" @click="resetForm(false)">新增</el-button>
            <el-button v-hasPermission="'group:del'" @click="handleDel">删除</el-button>
        </el-form-item>
    </el-form>
...
export default {
    ...
    methods: {
        ...
        confirmDel () {
            ...
            this.$post('/group/msg/del', params).then(res => {
                if (res) {
        ...
        handleSave () {
            let url = this.addForm.title === '新增' ? '/group/msg/add' : '/group/msg/update'
        ...
        init () {
            ...
            this.$post('/group/msg/list', params).then(res => {
                if (res) {

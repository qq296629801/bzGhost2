...
<div class="projects box-wrap">
    <el-form @submit.native.prevent>
        ...
        <el-form-item>
            <el-button v-hasPermission="'comment:add'" type="primary" @click="resetForm(false)">新增</el-button>
            <el-button v-hasPermission="'comment:del'" @click="handleDel">删除</el-button>
        </el-form-item>
    </el-form>
...
export default {
    ...
    methods: {
        ...
        confirmDel () {
            ...
            this.$post('/post/comment/del', params).then(res => {
                if (res) {
        ...
        handleSave () {
            let url = this.addForm.title === '新增' ? '/post/comment/add' : '/post/comment/update'
        ...
        init () {
            ...
            this.$post('/post/comment/list', params).then(res => {
                if (res) {

...
<div class="projects box-wrap">
    <el-form @submit.native.prevent>
        ...
        <el-form-item>
            <el-button v-hasPermission="'post:add'" type="primary" @click="resetForm(false)">新增</el-button>
            <el-button v-hasPermission="'post:del'" @click="handleDel">删除</el-button>
        </el-form-item>
    </el-form>
...
export default {
    ...
    methods: {
        ...
        confirmDel () {
            ...
            this.$post('/post/del', params).then(res => {
                if (res) {
        ...
        handleSave () {
            let url = this.addForm.title === '新增' ? '/post/add' : '/post/update'
        ...
        init () {
            ...
            this.$post('/post/list', params).then(res => {
                if (res) {

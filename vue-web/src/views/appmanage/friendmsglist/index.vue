...
<div class="projects box-wrap">
    <el-form @submit.native.prevent>
        ...
        <el-form-item>
            <el-button v-hasPermission="'friend:add'" type="primary" @click="resetForm(false)">新增</el-button>
            <el-button v-hasPermission="'friend:del'" @click="handleDel">删除</el-button>
        </el-form-item>
    </el-form>
...
export default {
    ...
    methods: {
        ...
        confirmDel () {
            ...
            this.$post('/friend/msg/del', params).then(res => {
                if (res) {
        ...
        handleSave () {
            let url = this.addForm.title === '新增' ? '/friend/msg/add' : '/friend/msg/update'
        ...
        init () {
            ...
            this.$post('/friend/msg/list', params).then(res => {
                if (res) {
